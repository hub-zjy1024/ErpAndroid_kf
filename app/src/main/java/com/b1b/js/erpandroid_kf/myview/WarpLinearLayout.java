...
public class WarpLinearLayout extends ViewGroup {
    ...
    public WarpLinearLayout(Context context, TableAdapter.TableRow tableRow, int textColor, int textSize) {
        super(context);
        ...
        if (this.tableRow != null) {
            for (int i = 0; i < tableRow.getSize(); i++) {//逐个格单元添加到行
                ...
                if (tableCell != null) {
                    ...
                    textCell.setMaxLines(3);
                    if (this.textColor != 0) {
                        textCell.setTextColor(this.textColor);
                    }
                    textCell.setTextSize(this.textSize);
                    addView(textCell);
                    ViewGroup.LayoutParams layoutParams = textCell.getLayoutParams();
                    layoutParams.width = tableCell.width;
                    layoutParams.height = tableCell.height;
...
//                lineWidth += mType.horizontal_Space;
    ...
    private final static class Type {
        ...
        */
         ...
         * 水平间距,单位px
         */
        private float horizontal_Space=0;
        /**
         * 垂直间距,单位px
         */
        private float vertical_Space=0;
        /**
         是否自动填满
         */
