 ...
 */
public class ZoomImageView2 extends ZoomImageView implements NestedScrollingChild2 {
                ...
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        ...
                        if (getScale() < mMidScale) {
                            postDelayed(new ZoomImageView2.AutoScaleRunnable(mMidScale, x, y), 16);
                            isAutoScale = true;
                        } else {
                            postDelayed(new ZoomImageView2.AutoScaleRunnable(mInitScale, x, y), 16);
                            isAutoScale = true;
                        }
                        return true;
                    }
...
//        return super.onTouch(this, event);
//    }
